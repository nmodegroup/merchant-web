...
export function getTodayOrderList(params) {
  return new Promise((resolve, reject) => {
    httpManager
      ...
      .get('https://easy-mock.com/mock/5d4fcefa5bff847d28d02903/merchant/table/order/today', params)
      .then(res => {
        console.log('res:', res);
        resolve(res);
      })
...
export function getFutureOrderList(params) {
  return new Promise((resolve, reject) => {
    httpManager
      ...
      .get('https://api.bmkee.com/mock/21/merchant/table/order/future', params)
      .then(res => {
        resolve(res);
      })
      .catch(err => {
...
export function getHistoryOrderList(params) {
  return new Promise((resolve, reject) => {
    httpManager
      ...
      .get('https://api.bmkee.com/mock/21/merchant/table/order/history', params)
      .then(res => {
        resolve(res);
      })
      .catch(err => {
...
export function confirmOrder(params) {
  return new Promise((resolve, reject) => {
    httpManager
      .put('/merchant/table/order', params)
      .then(res => {
        resolve(res);
      })
      .catch(err => {
